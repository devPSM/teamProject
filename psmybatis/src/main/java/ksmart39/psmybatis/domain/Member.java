package ksmart39.psmybatis.domain;
...
public class Member {
	...
	public String toString() {
		return "Member [memberId=" + memberId + ", memberPw=" + memberPw + ", memberPwCheck=" + memberPwCheck
				+ ", memberName=" + memberName + ", memberLevel=" + memberLevel + ", memberEmail=" + memberEmail
				+ ", memberAddr=" + memberAddr + ", memberRegDate=" + memberRegDate + "]";
	}
